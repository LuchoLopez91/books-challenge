...
CREATE TABLE `booksauthors` (
  ...
  PRIMARY KEY (`Id`),
  KEY `booksauthors_ibfk_1` (`AuthorId`),
  KEY `booksauthors_ibfk_2` (`BookId`),
  CONSTRAINT `booksauthors_ibfk_1` FOREIGN KEY (`AuthorId`) REFERENCES `authors` (`Id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `booksauthors_ibfk_2` FOREIGN KEY (`BookId`) REFERENCES `books` (`Id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2023-06-24 16:04:05
